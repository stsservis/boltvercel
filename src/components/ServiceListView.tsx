    ...
    <div className="flex flex-col bg-transparent">
      ...
      {shareModalService && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full max-h-[90vh] overflow-hidden">
      ...
      {statusFilter === 'all' && (
        <div className="p-8 text-center text-gray-500 flex-1 flex flex-col justify-center bg-transparent">
